        ...
        <div class= "container">
            ...
            <div id= 'home' class="row text-center">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="jumbotron">
                            ...
                            <h3 class="display-4"> Single ticket to Alaska</h3>
                            ...
                            <a href="/alaska">
                                <button type="button" class="btn btn-outline-light btn-lg">Click to read !</button>
                            </a>
            ...
            <div id="about" class="row text-center">
                ...
                <div class="col-lg-6">
                    ...
                    <img src="/img/portrait.jpeg" alt="Jean Forteroche" class="img-thumbnail">

                    <p>
                        Mus sed interdum nunc dictum rutrum scelerisque erat a parturient condimentum potenti dapibus vestibulum condimentum per tristique porta. Torquent a ut consectetur a vel ullamcorper a commodo a mattis ipsum class quam sed eros vestibulum quisque a eu nulla scelerisque a elementum vestibulum.
                    </p>
